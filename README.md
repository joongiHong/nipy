...
![test pass](https://img.shields.io/badge/test-passing-brightgreen)
...
| 목차                                                                                                                                                                                                  |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [모듈 설치하기](#모듈-설치하기)<br/>[학교 고유 코드 api (Scode)](#학교-고유-코드-api)<br/>[학교 급식 정보 api (Smeal)](#학교-급식-정보-api)<br/>[학사 일정 정보 api (Scalendar)](#학사-일정-정보-api) |
...
파일 저장을 원치 않을 경우 딕셔너리 형식으로 반환받을 수 있습니다.

```python
# 경기과고의 19년 9월자 중식 급식을 딕셔너리 형식으로 반환합니다.
m.month("2019", "09", "2", "d")
```
...
딕셔너리로 받은 경우 key 값에 날짜를 넣어 급식 정보를 반환받을 수 있습니다.
...
우선 학사 일정을 조회할 학교의 기본 정보를 설정하여야 합니다. 예시는 다음과 같습니다.
...
| 매개변수(예시) | 이름     | 설명                                                                                   |
| -------------- | -------- | -------------------------------------------------------------------------------------- |
| 경기           | 지역명   | 학교가 소재한 지역이름입니다.<br/>시, 도를 제외한 2자리 문자열 자료형입니다.           |
| J100000447     | 학교코드 | 조회할 학교 고유코드를 입력합니다.<br/>문자열 자료형입니다.                            |
| 4              | 교급     | 조회할 학교의 교급을 입력합니다.<br/>2자리 문자열 자료형입니다.<br/>부록을 참고하세요. |
...
`month()`를 사용하면 한달치 학사 일정을 불러올 수 있습니다.
...
`year()`를 사용하면 일년치 학사 일정을 엑셀이나 딕셔너리로 저장할 수 있습니다.
...
위의 매개변수를 올바르게 입력하시면 다음과 같은 결과를 받으실 수 있습니다.  
만약 딕셔너리로 출력 옵션을 선택하셨다면 다음과 같이 반환됩니다.
